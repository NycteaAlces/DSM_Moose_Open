...
#####################################################################   
    ...
    survey.area359.TTM <- readOGR(shp_original$datapath[6], shp_original$name)
    #survey.area359.TTM <- readOGR(input$WMU_Shp$datapath[6], input$WMU_Shp$Name)#substr(basename(GISInput),1,nchar(basename(GISInput))-4))
